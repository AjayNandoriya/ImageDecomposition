...
def test_get_avg_angular_kernel_0():
    """Test the get_avg_angular_kernel() function with 0 degree."""

    kernel_half_width = 5
    # Get the average angular kernel.
    avg_angular_kernel = get_avg_angular_kernel(kernel_half_width=kernel_half_width, angle=0, tight=True)
...
def test_get_avg_angular_kernel_45():
    """Test the get_avg_angular_kernel() function with 45 degree."""
    kernel_half_width = 5
    # Get the average angular kernel.
    avg_angular_kernel = get_avg_angular_kernel(kernel_half_width=kernel_half_width, angle=45, tight=True)
...
def test_get_avg_angular_kernel_90():
    """Test the get_avg_angular_kernel() function with 90 degree."""

    kernel_half_width = 5
    # Get the average angular kernel.
    avg_angular_kernel = get_avg_angular_kernel(kernel_half_width=kernel_half_width, angle=90, tight=True)
